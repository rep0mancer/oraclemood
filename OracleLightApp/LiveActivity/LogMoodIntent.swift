//
// NOTE: The live-activity AppIntent is implemented in the OracleLightWidget target.
// This file is intentionally disabled to avoid duplicate symbol definitions when
// compiling the main application. If you need to reference LogMoodIntent,
// import it from the widget extension.
//
#if false
import Foundation
import AppIntents
